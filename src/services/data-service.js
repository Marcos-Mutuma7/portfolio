...
const DataService = () => {
  return (
    <Box sx={styles.boostAgencies}>
      <Container>
      <BlockTitle
          title="Our Data Analyst Services"
        ...
        <Box sx={styles.row}>
          ...
          <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                ...
                <Text as="p">
                At Sigma, We help our clients to optimize their capabilities to leverage various types of data. Our business intelligence services include development and consulting, data visualization, and testing.
                </Text>
              </Box>
             </Box>
          </Flex>
...
const styles = {
  boostAgencies: {
    pt: ['70px', null, null, '80px', '120px', null, '0px'],
